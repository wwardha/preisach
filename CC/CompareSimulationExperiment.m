function CompareSimulationExperiment(filename, model, expname)
    ...
    if (model == "cc")
        ...
        sigmam = 4;
        sigmac = mean(dat(iexp,208)) * maxSigmac;
        ...
        disp('Generate Preisach Distribution for ' + fr + ' with sigmam = ' + sigmam + ', sigmac = ' + sigmac);
        ...
        lgd = legend('Experiment','Cauchy-Cauchy');
        lgd.Location = 'northwest';
        hold off;
        
        disp("Ps Cauchy-Cauchy = " + num2str(Pss));
        disp("Pr Cauchy-Cauchy = " + num2str(Prs));
        disp("Ec Cauchy-Cauchy = " + num2str(Ecs));
