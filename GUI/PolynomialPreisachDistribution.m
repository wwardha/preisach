function [result, iter] = PolynomialPreisachDistribution(a0, A, B, C, x0, y0, nSpline, nc, nLevel, iter, f)   
    ...
    waitbar(0,f,'Calculate Contours...');
    ...
    if(nLevel > 0)
        cmti=LinesIntersection(a0,x0,y0,cm0,group,ndeg,true,f); 
    else
        cmti=LinesIntersection(a0,x0,y0,cm0,group,ndeg,false,f); 
    end
    ...
    group = gmaxc;
    cmtc=LinesIntersection(a0,x0,y0,cmo,group,ndeg,true,f);         
